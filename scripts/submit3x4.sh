...
#SBATCH -o /data/kidney/kidney_histo/logs/slurm_%j.txt      # Path to save slurm_logs (‰j is the job number).
...
srun python3 -u /data/kidney/kidney_histo/Relapse_classifier/$@ --num_gpus 4 --num_nodes 3
